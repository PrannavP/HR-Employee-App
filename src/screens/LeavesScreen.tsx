...
const LeavesScreen = () => {
	const [activeTab, setActiveTab] = useState<"leaves" | "askLeaves">(
		"leaves"
	);
		...
		<View style={styles.container}>
			...
			<View style={styles.tabContainer}>
				<TouchableOpacity
					style={[
						styles.tabButton,
						activeTab === "leaves" && styles.activeTab,
					]}
				...
				<TouchableOpacity
					style={[
						styles.tabButton,
						activeTab === "askLeaves" && styles.activeTab,
					]}
				...
				>
					<Text
						style={[
							styles.tabText,
							activeTab === "askLeaves" && styles.activeTabText,
						]}
					>
						Ask Leaves
					</Text>
			...
			<View style={styles.contentContainer}>
				{activeTab === "leaves" ? <LeavesTab /> : <AskLeavesTab />}
			</View>
		</View>
	);
};
